...
from Python_lib.Setup_Factories import Setup_Stub_Factory, Setup_Toptica_Factory, Setup_Arroyo_Factory
...
setup_factory = Setup_Arroyo_Factory()  # Change to Setup_Stub_Factory for testing purposes
...
# Laser controller
laser = setup_factory.create_laser(resource_manager, resource_list[3])
laser.turn_on_laser()
laser.print_emission_status()
...
pt = tune_laser_window(laser, detector_list)
