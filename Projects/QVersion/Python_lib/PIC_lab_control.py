...
class LMS_AGILENT_8164B:  # developer: Lars Nielsen, Mads Larsen, Andreas Hänsel
    ...
    def GetWLScan(self, StartWL=1540, StopWL=1560, SweepTime=20, Cycles=1, stepWidthNM=1, SweepMode='oneway'):

        # Speed=int(round((StopWL-StartWL)/SweepTime)); #in nm/s
        self.instr.write(':SOUR' + str(int(self.SourceSlot)) + ':WAV:SWE:SPE ' + str(SweepTime) + 'NM/S')
...
class PM100USB:  # developer: Lars Nielsen
    ...
    def __init__(self, lambda0=1550):
        self.PDinstr = TLPM()
