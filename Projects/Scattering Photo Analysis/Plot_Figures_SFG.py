...
fit_x = np.delete(x_length_crop_mu_array, np.flip(y > 20))[0:-200]
fit_y = np.flip(np.delete((y - average_background_list), y > 20))[0:-200]
...
plt.plot(fit_x, moving_average_padding(fit_y, 200), 'b-')
