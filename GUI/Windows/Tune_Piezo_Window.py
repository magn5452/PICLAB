...
class Tune_Piezo_Window:
    ...
    def get_controller_info(self):
        if len(self.instrument_controller.get_piezo_list()) > 0:
            controller = self.instrument_controller.get_target_piezo()
    ...
    def set_x_voltage_button(self):
        self.instrument_controller.get_target_piezo().set_x_voltage(
            get_float_from_string(self.entry_1.get(),
                                  self.instrument_controller.get_target_piezo().get_x_voltage()))

    def set_y_voltage_button(self):
        self.instrument_controller.get_target_piezo().set_y_voltage(
            get_float_from_string(self.entry_2.get(),
                                  self.instrument_controller.get_target_piezo().get_y_voltage()))

    def set_z_voltage_button(self):
        self.instrument_controller.get_target_piezo().set_z_voltage(
            get_float_from_string(self.entry_3.get(),
                                  self.instrument_controller.get_target_piezo().get_z_voltage()))

    def set_x_resolution_button(self):
        self.instrument_controller.get_target_piezo().set_x_resolution(
            get_float_from_string(self.entry_4.get(),
                                  self.instrument_controller.get_target_piezo().get_x_resolution()))

    def set_y_resolution_button(self):
        self.instrument_controller.get_target_piezo().set_y_resolution(
            get_float_from_string(self.entry_5.get(),
                                  self.instrument_controller.get_target_piezo().get_y_resolution()))

    def set_z_resolution_button(self):
        self.instrument_controller.get_target_piezo().set_z_resolution(
            get_float_from_string(self.entry_6.get(),
                                  self.instrument_controller.get_target_piezo().get_z_resolution()))
    ...
    def button_down_x_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_x_voltage_set()
        update_voltage = voltage - piezo.get_x_resolution()
        piezo.set_x_voltage(update_voltage)

    def button_down_y_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_y_voltage_set()
        update_voltage = voltage - piezo.get_y_resolution()
        piezo.set_y_voltage(update_voltage)

    def button_down_z_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_z_voltage_set()
        print(voltage)
        update_voltage = voltage - piezo.get_z_resolution()
        print(self.tune_step_voltage)
        print(update_voltage)
        piezo.set_z_voltage(update_voltage)

    def button_up_x_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_x_voltage_set()
        update_voltage = voltage + piezo.get_x_resolution()
        piezo.set_x_voltage(update_voltage)

    def button_up_y_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_y_voltage_set()
        update_voltage = voltage + piezo.get_y_resolution()
        piezo.set_y_voltage(update_voltage)

    def button_up_z_command(self):
        piezo = self.instrument_controller.get_target_piezo()
        voltage = piezo.get_z_voltage_set()
        update_voltage = voltage + piezo.get_z_resolution()
        piezo.set_z_voltage(update_voltage)

    def next_piezo_button(self):
        self.instrument_controller.next_piezo()
